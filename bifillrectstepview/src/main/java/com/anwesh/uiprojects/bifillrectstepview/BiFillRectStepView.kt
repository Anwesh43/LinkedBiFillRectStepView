...
class BiFillRectStepView(ctx : Context) : View(ctx) {
    ...
    data class BiFillRectStep(var i : Int) {

        private var root : BFRNode = BFRNode(0)

        private var curr : BFRNode = root
    ...
    companion object {
        ...
        fun create(activity : Activity) : BiFillRectStepView {
            val view : BiFillRectStepView = BiFillRectStepView(activity)
